...
public class GraphicOverlay extends View {
    ...
    private void init() {
        ...
        FaceGraphic.mHintOutlinePaint.setColor( Color.GREEN );
        FaceGraphic.mHintOutlinePaint.setStyle( Paint.Style.STROKE );
        FaceGraphic.mHintOutlinePaint.setStrokeWidth(5);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(left, top, right, bottom, FaceGraphic.mHintOutlinePaint);
        synchronized (mLock) {
